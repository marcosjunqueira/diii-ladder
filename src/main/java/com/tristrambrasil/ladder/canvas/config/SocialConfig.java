...
import com.tristrambrasil.ladder.canvas.user.SecurityContext;
import com.tristrambrasil.ladder.canvas.user.SimpleConnectionSignUp;
import com.tristrambrasil.ladder.canvas.user.SimpleSignInAdapter;
import com.tristrambrasil.ladder.canvas.user.User;
...
public class SocialConfig {
    ...
    public ProviderSignInController providerSignInController() {
        ...
        signInController.setPostSignInUrl("http://apps.facebook.com/caronauniversitaria/");
